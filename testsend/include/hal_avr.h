 ...
 */
#define SLP_TR              ( 0x05 )//uploaded by wjy
 ...
 *  \ingroup hal_avr_board
 */
#define RST                 ( 0x04 )// uploaded by wjy
...
#define NET_LED           ( 0x01 )
#define HAL_PORT_NET_LED   ( PORTF )
#define HAL_DDR_NET_LED   (DDRF)

#define hal_clear_net_led()  ( HAL_PORT_NET_LED |= (1<< NET_LED))
#define hal_set_net_led() ( HAL_PORT_NET_LED &=~ (1 << NET_LED))


#define DATA_LED        ( 0x00 )
#define HAL_PORT_DATA_LED   ( PORTF )
#define HAL_DDR_DATA_LED   (DDRF)
...
#define HAL_ENABLE_INPUT_CAPTURE_INTERRUPT( ) ( TIMSK |= ( 1 << TICIE1 ) )//uploaded by wjy
#define HAL_DISABLE_INPUT_CAPTURE_INTERRUPT( ) ( TIMSK &= ~( 1 << TICIE1 ) )// uploaded by wjy

#define HAL_ENABLE_OVERFLOW_INTERRUPT( ) ( TIMSK |= ( 1 << TOIE1 ) )// uploaded by wjy
#define HAL_DISABLE_OVERFLOW_INTERRUPT( ) ( TIMSK &= ~( 1 << TOIE1 ) )// uploaded by wjy
